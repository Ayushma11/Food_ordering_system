        ...
        <div class="modal-body">
            <form action="partials/_manageCart.php" method="post">
                <div class="form-group">
                    ...
                    <input class="form-control" id="address" name="address" placeholder="tinkune" type="text" required minlength="3" maxlength="500">
                </div>
                <div class="form-group">
                    <b><label for="address1">Address Line 2:</label></b>
                    <input class="form-control" id="address1" name="address1" placeholder="shantinagar gate, near NSC College" type="text">
                </div>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6 mb-0">
                        <b><label for="hn">House No:</label></b>
                        <input type="text" class="form-control" id="hn" name="hn" placeholder="xxxx" required pattern="[0-9]{4}" maxlength="4">                    
                    </div>
                </div>
                <div class="form-group">
